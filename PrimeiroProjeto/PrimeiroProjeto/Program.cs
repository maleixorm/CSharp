...
//List<string> listaDasBandas = new List<string> { "Iron Maiden", "Led Zeppelin", "Mettalica" };
...
void ExibirOpcoesDoMenu ()
{
    ...
    Console.WriteLine("4 - Media de avaliação da Banda");
...
void ExibirMedia()
{
    ...
    Console.Write("Digite o nome da banda que deseja exibir a média das avaliações: ");
    string nomeDaBanda = Console.ReadLine()!;
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
